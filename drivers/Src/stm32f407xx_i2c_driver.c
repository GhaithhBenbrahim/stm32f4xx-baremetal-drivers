 ...
 *
 * @param[in]         - pI2Cx: Pointer to I2C peripheral register structure
 *
 * @return            - None
 *
 * @Note              - Sets the START bit in CR1 register
 */
static void I2C_GenerateStartCondition(I2C_RegDef_t *pI2Cx)
{
 ...
 *
 * @brief             - Prepares and sends slave address for write operation
 *
 * @param[in]         - pI2Cx: Pointer to I2C peripheral register structure
 ...
 *
 * @brief             - Prepares and sends slave address for read operation
 *
 * @param[in]         - pI2Cx: Pointer to I2C peripheral register structure
 * @param[in]         - SlaveAddr: 7-bit slave address
 *
 ...
 *
 * @brief             - Enables/disables interrupt events for slave mode
 *
 * @param[in]         - pI2Cx: Pointer to I2C peripheral register structure
 ...
 *
 * @brief             - Controls I2C peripheral clock
 *
 * @param[in]         - pI2Cx: Pointer to I2C peripheral register structure
 * @param[in]         - EnorDi: ENABLE or DISABLE macro
 *
 ...
 *
 * @brief             - Calculates APB1 peripheral clock frequency
 *
 ...
 * @return            - None
 *
 * @Note              - Handles reset for I2C1, I2C2, I2C3
 */
 ...
 *
 * @brief             - Checks status of specified I2C flag
 *
 * @param[in]         - pI2Cx: Pointer to I2C peripheral register structure
 * @param[in]         - FlagName: Flag to check (I2C_FLAG_xxx)
 *
 * @return            - Flag status (SET or RESET)
 *
 * @Note              - Checks flag in SR1 register
 */
 ...
 *
 * @brief             - Blocking master transmit operation
 *
 * @param[in]         - pI2CHandle: Pointer to I2C handle structure
 * @param[in]         - pTxbuffer: Pointer to transmit buffer
 * @param[in]         - Len: Number of bytes to transmit
 * @param[in]         - SlaveAddr: 7-bit slave address
 * @param[in]         - Sr: Repeated start control (ENABLE/DISABLE)
 *
 * @return            - None
 *
 * @Note              - Implements complete I2C master transmit sequence
 *                    - Generates STOP condition unless Sr is ENABLE
 */
 ...
 *
 * @brief             - Blocking master receive operation
 *
 * @param[in]         - pI2CHandle: Pointer to I2C handle structure
 ...
 *                    - Handles single and multi-byte reception
 */
 ...
 * @fn      		  - I2C_ManageAcking
 *
 * @brief             - Controls ACK generation for received bytes
 *
 * @param[in]         - pI2Cx: Pointer to I2C peripheral register structure
 * @param[in]         - EnorDi: Enable/disable ACK (I2C_ACK_ENABLE/DISABLE)
 *
 * @return            - None
 *
 ...
 *
 * @param[in]         - IRQNumber: I2C interrupt number
 * @param[in]         - EnorDi: Enable/disable interrupt (ENABLE/DISABLE)
 *
 * @return            - None
 *
 ...
 *                    - Calculates correct NVIC priority register offset
 */
 ...
 *
 * @brief             - Non-blocking master transmit using interrupts
 *
 * @param[in]         - pI2CHandle: Pointer to I2C handle structure
 * @param[in]         - pTxBuffer: Pointer to transmit buffer
 * @param[in]         - Len: Number of bytes to transmit
 ...
 *
 * @Note              - Must check TxRxState before starting new transfer
 *                    - Enables necessary interrupts for transfer
 */
 ...
 *
 * @brief             - Non-blocking master receive using interrupts
 *
 * @param[in]         - pI2CHandle: Pointer to I2C handle structure
 * @param[in]         - pRxBuffer: Pointer to receive buffer
 * @param[in]         - Len: Number of bytes to receive
 ...
 *
 * @brief             - Handles I2C error interrupts and notifies application
 *
 * @param[in]         - pI2CHandle: Pointer to I2C handle structure
 *
 * @return            - None
 *
 * @Note              - Checks and clears all I2C error flags
 *                    - Calls application callback with specific error code
 *                    - Requires these macros in driver header file:
